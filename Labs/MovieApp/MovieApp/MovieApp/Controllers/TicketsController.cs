...
namespace MovieApp.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> AddTicketToOrder(Guid Id)
        {
            ...
            var selectedMovie = await _context.Movies.FirstOrDefaultAsync(m => m.Id == selectedTicket.MovieId);
            if (selectedTicket != null)
            {
                var model = new AddToOrderDTO
                {
                    SelectedTicketName = selectedMovie.MovieName,
        ...
        public async Task<IActionResult> AddTicketToOrder(AddToOrderDTO model)
        {
            ...
            if (userId != null)
            {
                ...
                {
                    userOrder.TicketsInOrder.Add(new TicketInOrder
                    {
                        Ticket = selectedTicket,
                        TicketId = selectedTicket.Id,
                        Order = userOrder,
                        OrderId = Guid.Parse(userOrder.OwnerId),
